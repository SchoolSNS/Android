...
class EditFeedSetImageAdapter(private val feedImageList : ArrayList<Bitmap>, private val context: Context): RecyclerView.Adapter<EditFeedSetImageAdapter.ViewHolder>() {
